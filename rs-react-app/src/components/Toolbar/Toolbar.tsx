...
export default function Toolbar({ selectedItems, clearSelectedItems }: ToolbarProps) {
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full flex flex-col items-center gap-2 text-lg p-4 bg-amber-100 dark:bg-gray-700 dark:text-white">
      ...
      <p>
        ...
        <button className="bg-purple-700 text-white rounded-md cursor-pointer text-base mx-4 px-4 py-2">
          Download All
        </button>
      </p>
    </div>
